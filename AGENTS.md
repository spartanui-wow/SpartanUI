...
This file covers SpartanUI-specific guidance. It **inherits** all shared rules from the root `C:\code\AGENTS.md` and `C:\code\.context\` files — do not duplicate content that lives there.
